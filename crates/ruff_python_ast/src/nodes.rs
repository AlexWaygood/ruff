...
impl ExprFString {
    /// Returns `Some(literal)` if the f-string only consists of a single [`FString`] part.
    /// Returns `None` if the f-string consists of multiple parts
...
impl FStringValue {
    ...
    pub const fn single_part(value: FString) -> Self {
        Self {
...
impl ExprStringLiteral {
    /// Returns `Some(literal)` if the string only consists of a single [`StringLiteral`] part.
    /// Returns `None` if the string consists of multiple parts
    /// (indicating that it is implicitly concatenated).
...
impl StringLiteralValue {
    ...
    pub const fn single_part(string: StringLiteral) -> Self {
        Self {
    ...
    ///
    /// For an implicitly concatenated string, returns `true` only if the first
...
impl ExprBytesLiteral {
    /// Returns `Some(literal)` if the bytestring only consists of a single [`BytesLiteral`] part.
    /// Returns `None` if the bytestring consists of multiple parts
    /// (indicating that it is implicitly concatenated).
...
impl BytesLiteralValue {
    /// Creates a new bytestring literal with a single [`BytesLiteral`] part.
    pub const fn single_part(value: BytesLiteral) -> Self {
        Self {
    ...
    /// Returns `true` if the node represents an empty bytestring.
    ///
